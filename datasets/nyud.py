...
class NYUD(torch.utils.data.Dataset):
    ...
    def __init__(self, root=MyPath.db_root_dir('NYUDv2'), dataidxs=None, train=True, transform=None, tasks=None):
        """
        Initialize the NYUDv2 Multi-Task Dataset
        ...
        :param data_num: Number of samples used in validation set
        """
        self.root = root
